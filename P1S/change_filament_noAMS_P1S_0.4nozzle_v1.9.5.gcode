...
{if toolchange_count > 1 && (z_hop_types[current_extruder] == 0 || z_hop_types[current_extruder] == 3)} ; Change the behavior depending on if this is the first time that we change the filament or not
G17
...
; Set the temporature for the new filament. Needed when printing with a prime tower.
M109 S[new_filament_temp]
{endif}